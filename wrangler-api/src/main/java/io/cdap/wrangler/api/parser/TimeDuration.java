 ...
 */
 ...
 public class TimeDuration implements Token {
   ...
   private void parse(String value) {
      ...
      switch (unit) {
        case "ms":
          ...
          break;
        case "s":
          this.value = (long) (number * 1000);
          break;
        case "m":
          this.value = (long) (number * 60 * 1000);
          break;
        case "h":
          this.value = (long) (number * 60 * 60 * 1000);
          break;
        case "d":
          this.value = (long) (number * 24 * 60 * 60 * 1000);
          break;
        case "w":
          this.value = (long) (number * 7 * 24 * 60 * 60 * 1000);
          break;
        case "mo":
          this.value = (long) (number * 30 * 24 * 60 * 60 * 1000);
          break;
        case "y":
          this.value = (long) (number * 365 * 24 * 60 * 60 * 1000);
          break;
        default:
  ...
  public Double getTimeInWeeks() {
    return (double) value / 1000 / 60 / 60 / 24 / 7;
  }

  public Double getTimeInMonths() {
    return (double) value / 1000 / 60 / 60 / 24 / 30;

  }

  public Double getTimeInYears() {
    return (double) value / 1000 / 60 / 60 / 24 / 365;
  }
